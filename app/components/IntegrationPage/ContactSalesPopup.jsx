...
const ContactSalesPopup = ({ isDropdownOpen, isSolutionOpen, isLearnOpen }) => {
  ...
  return (
    <>
      <div
        onClick={togglePopup}
        className={`flex h-[30px] items-center justify-center rounded-lg px-3 font-medium ${isDropdownOpen || isSolutionOpen || isLearnOpen ? "text-[#7B68EE]" : "text-white"} hover:bg-white hover:bg-opacity-10`}
      >
        <p>Contact Sales</p>
      </div>
      {isOpen && (

...
const LearnIntegrationDropdown = ({
  isOpen,
  setIsOpen,
  isDropdownOpen,
  isSolutionOpen,
          ...
          >
            <div className="container mx-auto w-full max-w-[1200px] ">
              <div className="flex justify-between">
                <div className="mx-[6px] w-full max-w-[730px]">
                  ...
                  <div className="grid grid-cols-3 gap-x-5 gap-y-3">
                    ...
                    <div className="flex h-[97px] items-center justify-center gap-[14px] rounded-[14px] px-[18px] duration-500 ease-in-out hover:bg-[#FD71AF] hover:bg-opacity-20">
                      <div>
                        ...
                        >
                          <path
                            d="M4.81602 4.96863L7.68268 3.17384V13.2826C7.68268 17.3173 11.153 20.5196 15.3466 20.5196C19.5402 20.5196 23.0105 17.3173 23.0105 13.2826V3.17384L25.8771 4.96863V13.2826C25.8771 18.6848 21.2015 23.1326 15.3466 23.1326C9.49165 23.1326 4.81602 18.6848 4.81602 13.2826V4.96863Z"
                            stroke="#FD71AF"
                            stroke-width="1.3"
                          ></path>
                          <path
                    ...
                    <div className="flex items-center gap-5">
                      <div className="flex h-[97px] items-center justify-center gap-[14px] rounded-[14px] px-[18px] duration-500 ease-in-out hover:bg-[#FD71AF] hover:bg-opacity-20">
                        ...
                        <div>
                          ...
                          <p className="mt-2 text-xs">
                            Get premium support and hands-on help from our
                      ...
                      <div className="flex h-[97px] items-center justify-center gap-[14px] rounded-[14px] px-[18px] duration-500 ease-in-out hover:bg-[#FD71AF] hover:bg-opacity-20">
                        ...
                        <div>
                          ...
                          <p className="mt-2 text-xs">
                            Find new opportunities, extend your services, and
                            scale your business with ClickUp's partner program.
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div className="w-full max-w-[480px] border-l pl-3">
                  <div className="flex w-full items-center justify-between">
                    <p className="mb-6 mt-9 text-sm font-bold uppercase leading-5">
                      Latest From Blog
                    </p>
                    <button className="mt-5 flex items-center justify-center gap-2 text-sm font-medium leading-6">
                    ...
                    <div className="mb-3 inline-flex items-center">
                      <div>
                        <Image
                          ...
                          height={60}
                          unoptimized
                          src="/images/How-to-Create.png"
                          alt="blog"
                          className="mr-4 rounded-[9px]"
                        />
                      </div>
                      <div>
                        <p className="text-[15px] leading-6">
                          How to Create an Effective 30-60-90 Day Plan for
                          Onboarding
                        </p>
                      </div>
                    </div>
                    <div className="mb-3 inline-flex items-center">
                      <div>
                        <Image
                          ...
                          height={60}
                          unoptimized
                          src="/images/Action-Plan-Templates-ClickUp-Blog-Image-150x150.png"
                          alt="blog"
                          className="mr-4 rounded-[9px] object-cover"
                        />
                      </div>
                      <p className="text-[15px] leading-6">
                    ...
                    <div className="mb-3 inline-flex items-center">
                      <div>
                        <Image
                          ...
                          height={60}
                          unoptimized
                          src="/images/Barcelona-for-Digital-Nomads-Your-Ultimate-Guide-to-Working-Remotely-in-Spains-Sun-Soaked-City-150x150.png"
                          alt="blog"
                          className="mr-4 rounded-[9px]"
                        />
                      </div>
                      <p className="text-[15px] leading-6">
                        Barcelona for Digital Nomads: Your Ultimate Guide to
                      </p>
                    </div>
                    <div className="mb-3 flex items-center">
                      <div>
                        <Image
                          ...
                          height={60}
                          unoptimized
                          src="/images/15-Best-Project-Management-Tools-in-2024-Blog-Feature-150x150.png"
                          alt="blog"
                          className="mr-4 rounded-[9px]"
                        />
                      </div>
...
export default LearnIntegrationDropdown;

...
const Tabs = () => {
  const [selectedTeam, setSelectedTeam] = useState("Projects");
  ...
  return (
    <>
      ...
      >
        <SwiperSlide>
          <div
            onClick={() => handleTeamClick("Projects")}
          ...
          >
            <div
              className={` flex h-[55px] w-[55px] items-center justify-center rounded-xl ${
                selectedTeam === "Projects"
                  ? "CuHomeTabs2 text-base font-extrabold text-[#24223e]"
                  : "CUHomeTabs"
              }`}
            >
              <svg
                ...
                stroke={selectedTeam === "Projects" ? "#ffffff" : "#7b73ae"}
              >
                <path
            ...
            <p
              className={`mt-3 ${
                selectedTeam === "Projects"
                  ? "text-base font-extrabold text-[#24223e]"
                  : "text-sm  font-medium  text-[#7b73ae]"
              } `}
            >
              Projects
            </p>
        ...
        <SwiperSlide>
          <div
            onClick={() => handleTeamClick("Dashboards")}
            className="mt-5 flex  cursor-pointer flex-col items-center justify-center"
          >
            <div
              className={`flex h-[55px] w-[55px] items-center justify-center rounded-xl ${
                selectedTeam === "Dashboards"
                  ? "CuHomeTabs2 text-base font-extrabold text-[#24223e]"
                  : "CUHomeTabs"
              }`}
            >
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                stroke={selectedTeam === "Dashboards" ? "#ffffff" : "#7b73ae"}
              >
                <path
          ...
          >
            ...
            >
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                stroke={selectedTeam === "AI" ? "#ffffff" : "#7b73ae"}
              >
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
          ...
          >
            ...
            >
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                stroke={selectedTeam === "Forms" ? "#ffffff" : "#7b73ae"}
              >
                <path
        ...
        <SwiperSlide>
          <div
            onClick={() => handleTeamClick("Sprints")}
            className="mt-5 flex  cursor-pointer flex-col items-center justify-center"
          >
            <div
              className={` flex h-[55px] w-[55px] items-center justify-center rounded-xl ${
            ...
            >
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                stroke={selectedTeam === "Sprints" ? "#ffffff" : "#7b73ae"}
              >
                <path
          ...
          >
            ...
            >
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                stroke={selectedTeam === "Docs" ? "#ffffff" : "#7b73ae"}
              >
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
          ...
          >
            ...
            >
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                stroke={selectedTeam === "Time" ? "#ffffff" : "#7b73ae"}
              >
                <path
          ...
          >
            ...
            >
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                stroke={selectedTeam === "Chat" ? "#ffffff" : "#7b73ae"}
              >
                <path
        ...
        <SwiperSlide>
          <div
            onClick={() => handleTeamClick("Whiteboards")}
            className="mt-5 flex  cursor-pointer flex-col items-center justify-center"
          >
            <div
              className={` flex h-[55px] w-[55px] items-center justify-center rounded-xl ${
                selectedTeam === "Whiteboards"
                  ? "CuHomeTabs2 text-base font-extrabold text-[#24223e]"
                  : "CUHomeTabs"
              }`}
            >
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                stroke={selectedTeam === "Whiteboards" ? "#ffffff" : "#7b73ae"}
              >
                <path
      ...
      <div className="container relative mx-auto mt-8 max-w-[1080px]">
        {selectedTeam && selectedTeam === "Projects" && <Projects />}
        {selectedTeam && selectedTeam === "Dashboards" && <Dashboards />}
        {selectedTeam && selectedTeam === "AI" && <AI />}
        {selectedTeam && selectedTeam === "Forms" && <Forms />}
        {selectedTeam && selectedTeam === "Sprints" && <Sprints />}
        {selectedTeam && selectedTeam === "Docs" && <Docs />}
        {selectedTeam && selectedTeam === "Time" && <Time />}
        {selectedTeam && selectedTeam === "Chat" && <Chat />}
        {selectedTeam && selectedTeam === "Whiteboards" && <Whiteboards />}
        <svg
          className="absolute -top-[132px] left-[136px] -z-20 hidden h-full max-h-[919px] w-full max-w-[1014px] xl:block"
          xmlns="http://www.w3.org/2000/svg"
          width="1014"
          height="919"
          viewBox="0 0 1014 919"
          fill="none"
        >
          <g opacity="0.4" filter="url(#filter0_f_801_83213)">
            <path
              ...
              fill="url(#paint0_linear_801_83213)"
            ></path>
          </g>
          <defs>
            <filter
              id="filter0_f_801_83213"
              x="0.451286"
              y="0.451286"
              width="1013.28"
              height="917.811"
            ...
            >
              ...
              ></feBlend>
              <feGaussianBlur
                stdDeviation="57.7744"
                result="effect1_foregroundBlur_801_83213"
              ></feGaussianBlur>
            </filter>
            <linearGradient
              id="paint0_linear_801_83213"
              x1="73"
              y1="326.5"
              x2="526.5"
              y2="191.5"
        ...
        <svg
          className="absolute -top-[136px] right-[136px] -z-20 hidden xl:block"
          xmlns="http://www.w3.org/2000/svg"
          width="1032"
          height="937"
          viewBox="0 0 1032 937"
          fill="none"
        >
          <g opacity="0.4" filter="url(#filter0_f_801_83212)">
            <path
              ...
              fill="url(#paint0_linear_801_83212)"
              fill-opacity="0.8"
            ></path>
          </g>
          <defs>
            <filter
              id="filter0_f_801_83212"
              x="0.816521"
              y="0.466423"
              width="1030.28"
              height="935.821"
            ...
            >
              ...
              <feGaussianBlur
                stdDeviation="57.7744"
                result="effect1_foregroundBlur_801_83212"
              ></feGaussianBlur>
            </filter>
            <linearGradient
              id="paint0_linear_801_83212"
              x1="641.5"
              y1="139"
              x2="812.5"
              y2="693"
        ...
        <div className="CuHomeTabs_wrapper absolute -z-20 hidden h-full w-full xl:block"></div>
      </div>
    </>
  );
};
